...
class Robot : public frc::TimedRobot {
 public:
  void AutonomousInit() override {
    ...
    Drivetrain dt;
    dt.m_leftLeadMotor.RestoreFactoryDefaults();
    dt.m_rightLeadMotor.RestoreFactoryDefaults();
    dt.m_leftFollowMotor.RestoreFactoryDefaults();
    dt.m_rightFollowMotor.RestoreFactoryDefaults();
    
    //Allowing back motors to follow front motors
    dt.m_leftFollowMotor.Follow(dt.m_leftLeadMotor);
    dt.m_rightFollowMotor.Follow(dt.m_rightLeadMotor);
    ...
    //Set trajectory to PathWeaver trajectory
    fs::path deployDirectory = frc::filesystem::GetDeployDirectory();
    deployDirectory = deployDirectory / "paths" / "HubToTerminalTestTrajectory.wpilib.json";
 ...
 private:
  ...
  // An example trajectory to follow (8729: we are following pathweaver trajectory)
